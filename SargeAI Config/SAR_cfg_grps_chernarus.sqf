...
if (SAR_dynamic_spawning) then {
    ...
    [["max_grps","rnd_grps","max_p_grp"],[[2,0,0],[35,0,0],[2,0,0]],"SAR_area_0_3"] call SAR_AI_mon_upd; 
...
//[SAR_marker_DEBUG_devilscastle,3,0,6,"fortify",true,1800] call SAR_AI;
