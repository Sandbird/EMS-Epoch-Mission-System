...
SAR_respawn_waittime = 1800; // 30 minutes, default was 90 seconds
...
SAR_DELETE_TIMEOUT = 900; // 15 minutes, default was 2 minutes
...
KRON_UPS_closeenough = 600; // if you have vast plain areas, increase this to sth around 150-300 
...
SAR_sniper_surv_list = ["Survivor2_DZ"]; // the potential classes of the snipers of a survivor group
...
SAR_leader_band_skills = [
    ...
    ["aimingAccuracy",0.20, 0.10], // skilltype, <min value>, <random value added to min>;
    ["aimingShake",   0.30, 0.10],
...
SAR_sold_leader_weapon_list = ["M4A3_CCO_EP1","M16A4_ACG","M4A1_AIM"];
SAR_sold_leader_pistol_list = [];   

// potential item list for leaders -> Item / Chance 1 - 100
SAR_sold_leader_items = [["ItemWaterbottle",30],["FoodSteakCooked",50],["FoodCanSardines",70],["HandGrenade_west",10],["ItemPainkiller",40]];
SAR_sold_leader_tools =  [["ItemMap",50],["ItemBandage",50],["ItemCompass",30],["NVGoggles",5],["ItemRadio",100],["ItemEtool",10],["ItemFlashlightRed",30]];

//potential weapon list for riflemen
SAR_sold_rifleman_weapon_list = ["M16A2","M4A1","MK_48_DZ"];
SAR_sold_rifleman_pistol_list = [];    

// potential item list for riflemen
SAR_sold_rifleman_items = [["ItemWaterbottle",30],["FoodSteakCooked",50],["FoodCanPasta",70],["ItemBandage",70],["ItemPainkiller",40]];
SAR_sold_rifleman_tools = [["ItemMap",50],["ItemCompass",30],["ItemFlashlightRed",30]];

//potential weapon list for snipers
SAR_sold_sniper_weapon_list = ["M24","SVD_CAMO","M14_EP1"];
SAR_sold_sniper_pistol_list = [];   

// potential item list for snipers
SAR_sold_sniper_items = [["ItemWaterbottle",30],["FoodSteakCooked",50],["FoodCanBakedBeans",70],["ItemBandage",70],["ItemPainkiller",40]];
SAR_sold_sniper_tools = [["ItemMap",50],["ItemCompass",30],["Binocular_Vector",5],["ItemFlashlightRed",30]];
...
// potential weapon list for leaders
SAR_surv_leader_weapon_list = ["LeeEnfield","Crossbow","Winchester1866"];
SAR_surv_leader_pistol_list = [];

// potential item list for leaders -> Item / Chance 1 - 100
SAR_surv_leader_items = [["ItemSodaCoke",30],["FoodCanBakedBeans",45]];
SAR_surv_leader_tools =  [["ItemMap",15],["ItemCompass",15],["Binocular",30],["ItemRadio",100]];

//potential weapon list for riflemen
SAR_surv_rifleman_weapon_list = ["LeeEnfield","Winchester1866"];
SAR_surv_rifleman_pistol_list = [];

// potential item list for riflemen
SAR_surv_rifleman_items = [["ItemSodaCoke",75],["FoodCanPasta",60]];
SAR_surv_rifleman_tools = [["ItemMap",5],["ItemCompass",5]];

//potential weapon list for snipers
SAR_surv_sniper_weapon_list = ["Huntingrifle"];
SAR_surv_sniper_pistol_list = [];

// potential item list for snipers
SAR_surv_sniper_items = [["ItemSodaCoke",30],["FoodCanSardines",45]];
SAR_surv_sniper_tools = [["ItemMap",5],["ItemCompass",5],["Binocular",15]];
...
// potential weapon list for leaders
SAR_band_leader_weapon_list = ["AKS_74_KOBRA","AK_47_M"];
SAR_band_leader_pistol_list = [];   

// potential item list for leaders -> Item / Chance 1 - 100
SAR_band_leader_items = [["ItemSodaCoke",75],["FoodCanPasta",60],["FoodSteakCooked",30]];
SAR_band_leader_tools =  [["ItemMap",20],["ItemCompass",15],["NVGoggles",2],["ItemWatch",1],["ItemRadio",100]];
...
// potential item list for riflemen
SAR_band_rifleman_items = [["ItemSodaCoke",75],["FoodCanBakedBeans",60],["30Rnd_556x45_Stanag",60],["30Rnd_556x45_Stanag",60]];
SAR_band_rifleman_tools = [["ItemMap",15],["ItemCompass",10]];

//potential weapon list for snipers
SAR_band_sniper_weapon_list = ["m16a4_acg","Huntingrifle"];
SAR_band_sniper_pistol_list = [];   

// potential item list for snipers
SAR_band_sniper_items = [["ItemSodaCoke",75],["FoodCanSardines",60],["Skin_Sniper1_DZ",100]];
SAR_band_sniper_tools = [["ItemMap",15],["ItemCompass",10],["Binocular_Vector",5],["ItemFlashlight",100]];
