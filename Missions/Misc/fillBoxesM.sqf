...
_crate addMagazineCargoGlobal ["ItemEpinephrine", 50];

_crate addMagazineCargoGlobal ["ItemPainkiller", 50];

_crate addMagazineCargoGlobal ["ItemWaterbottle", 100];

_crate addMagazineCargoGlobal ["FoodCanBakedBeans", 100];

_crate addMagazineCargoGlobal ["ItemAntibiotic", 10];

_crate addMagazineCargoGlobal ["ItemBloodbag", 25];
