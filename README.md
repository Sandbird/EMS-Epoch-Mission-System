...
<b>Replace with this:</b>
    ...
    if(vehicle _x != _x && !(vehicle _x in PVDZE_serverObjectMonitor) && (isPlayer _x)  && !(typeOf vehicle _x) in DZE_safeVehicle) && (typeOf vehicle _x) != ""Parachute"") && (typeOf vehicle _x) != ""ParachuteWest"") && (typeOf vehicle _x) != ""ParachuteC"") && (typeOf vehicle _x) != ""ParachuteG"") && (typeOf vehicle _x) != ""ParachuteEast"") && (vehicle _x getVariable [""Mission"",0] && (vehicle _x getVariable [""DZAI"",0] != 1) && (vehicle _x getVariable [""Sarge"",0] != 1)) then {" \n
